...
public class PhysicalProductRequestDAO extends ProductRequestDAO {
    ...
    public PhysicalProductRequestDAO(int id, LocalDate date, String status, String requestType, String title, int price, String description, LocalDate postDate, int count, String category, SellerDAO seller) {

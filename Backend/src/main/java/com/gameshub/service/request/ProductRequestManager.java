...
//            PhysicalProductRequestDAO physicalProductRequestDAO = productRequestMapper.toProductDAO((PhysicalProductRequestDTO) productRequestDTO);
...
//            DigitalProductRequestDAO digitalProductRequestDAO = productRequestMapper.toProductDAO((DigitalProductRequestDTO) productRequestDTO);

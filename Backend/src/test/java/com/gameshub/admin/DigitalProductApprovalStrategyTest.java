...
public class DigitalProductApprovalStrategyTest {
    ...
    private DigitalProductRequestDAO request;
    ...
    void setUp() {
        ...
        request = new DigitalProductRequestDAO(LocalDate.now(), "Pending", "Type", "Title", 10, "Desc", LocalDate.now(), 10, "Cat", seller, "Code");
        request.setId(1);
    }

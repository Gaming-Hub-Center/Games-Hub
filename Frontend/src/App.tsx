    ...
    return (
        ...
        >
            <Routes>
                ...
                <Route path="/physical-cart"
                       element={<RoleBasedRoute allowedRoles={['BUYER']}><PhysicalCart/></RoleBasedRoute>}></Route>
                <Route path="/digital-cart"
                       element={<RoleBasedRoute allowedRoles={['BUYER']}><DigitalCart/></RoleBasedRoute>}></Route>

                <Route path="/seller/create-product" element={<RoleBasedRoute
                    allowedRoles={['SELLER']}><CatalogRequestForm/></RoleBasedRoute>}></Route>
                ...
                <Route path="/buyer/productview/:id"
                       element={<RoleBasedRoute allowedRoles={(['BUYER'])}><ProductView/></RoleBasedRoute>}></Route>

                <Route path="/admin/dashboard"
                       element={<RoleBasedRoute allowedRoles={['ADMIN']}><HomePageAdmin/></RoleBasedRoute>}></Route>

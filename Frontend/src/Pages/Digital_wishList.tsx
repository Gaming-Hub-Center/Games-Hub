...
const DigitalWishlist = () => {
  ...
  const fetchWishlistItems = () => {
    httpRequest("get", `/wishlist/digital?buyerId=${buyerId}`)
      .then((response) => {
  ...
  const onDeleteItem = (productId: number) => {
    ...
    httpRequest("delete", `/wishlist/digital/remove`, wishlistDTO)
      .then(() => {
        fetchWishlistItems();
      })
      .catch((error) => {
...
export default DigitalWishlist;

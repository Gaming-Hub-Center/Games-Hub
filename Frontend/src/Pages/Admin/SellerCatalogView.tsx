...
export function SellerCatalogView() {
    ...
    //             <Col md={12}><h2>Digital Products</h2></Col>
    //         </Row>
    //         <Row className="justify-content-md-center">
    //             {currentDigitalProducts.map((product, index) => (
    //                 <Col key={index} md={4} className="mb-4 d-flex align-items-stretch">
    //                     <Card style={{ backgroundColor: 'black', color: 'white', width: '18rem', margin: '0 auto' }}>
    //                         <Card.Header as="h5" style={{ backgroundColor: '#733BC0', color: 'black' }}>{product.title}</Card.Header>
    //                         <Card.Img variant="top" src={`data:image/jpeg;base64,${product.image}`} />
    //                         <Card.Body>
    //                             <Card.Title>Price: {product.price}</Card.Title>
    //                             <Card.Text><strong>{product.description}</strong></Card.Text>
    //                             <Card.Text><strong>ID: {product.id}</strong></Card.Text>
    //                         </Card.Body>
    //                     </Card>
    //                 </Col>
    //             ))}
    ...
    //             </Col>
    //         </Row>
    //         <Row className="justify-content-md-center text-center mt-4 mb-4">
    //             <Col md={12}><h2>Physical Products</h2></Col>
    //         </Row>
    //         <Row className="justify-content-md-center">
    //             {currentPhysicalProducts.map((product, index) => (
    //                 <Col key={index} md={4} className="mb-4 d-flex align-items-stretch">
    //                     <Card style={{ backgroundColor: 'black', color: 'white', width: '18rem', margin: '0 auto' }}>
    //                         <Card.Header as="h5" style={{ backgroundColor: '#733BC0', color: 'black' }}>{product.title}</Card.Header>
    //                         <Card.Img variant="top" src={`data:image/jpeg;base64,${product.image}`} />

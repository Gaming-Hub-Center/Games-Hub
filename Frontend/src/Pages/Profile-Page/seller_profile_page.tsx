...
import { getId, getName, getEmail, getPhone, getAddress, getBalance, getNationalID, getDateJoined,getSellerDescription, getVatRegistrationNumber } from '../../session/CurrentSession';
